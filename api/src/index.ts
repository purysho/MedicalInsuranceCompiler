...
app.get("/mcp", (_req, res) => {
  res.json({
    ...
    endpoint: "/mcp",
    tools: ["alice_fhir_search","alice_fhir_read","alice_policy_check","alice_run_medrec","alice_run_evidence","alice_run_compose","alice_run_full_prior_auth","alice_extract_clinical_note"],
  });
});
